...
- [Documentation](https://github.com/nvim-telescope/telescope.nvim#features)
- [Examples](https://github.com/nvim-telescope/telescope.nvim/wiki/Example-Configurations)
