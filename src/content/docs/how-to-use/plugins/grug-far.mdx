...
## Reference Links
- [GitHub Repository](https://github.com/roobert/find-replace.nvim)
- [Documentation](https://github.com/roobert/find-replace.nvim#-features)
- [Examples](https://github.com/roobert/find-replace.nvim#-examples) 